 ...
 */
public class text_news extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getJSON("http://election2.intellecttechnosoft.com/sd_uploads/get_plainnews.php");
    ...
    private void loadIntoListView(String json) throws JSONException {
        if (json != null) {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                dataModels.add(new DataModelNews(obj.getString("title_2"), obj.getString("description"), obj.getString("img_1")));
            }
            adapter = new CustomNewsAdapter(dataModels, getContext());
